...
task('snapshot-stake', 'Generates snapshot of token holders')
	...
	.setAction(async (taskArgs, hre) => {
		...
		do {
			...
			response.logs.forEach((log) => {
				...
				if (
					from.toLowerCase() == '0xa5f8C5Dbd5F286960b9d90548680aE5ebFf07652'.toLowerCase() ||
					to.toLowerCase() == '0xa5f8C5Dbd5F286960b9d90548680aE5ebFf07652'.toLowerCase()
				)
					return;
